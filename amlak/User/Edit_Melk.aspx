<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true"
    CodeBehind="Edit_Melk.aspx.cs" Inherits="amlak.User.Edit_Melk" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="font-size: small; font-family: tahoma, arial; color: #333333; background-color: #6681BA;
        ...
        <p>
            <span class="style1">*</span> کاربر گرامی در صورتی که میخواهید اطلاعات ملک خود را
            وارد کنید بعد از&nbsp; انتخاب نوع ملک و وارد کردن داده ها و اطمینان از صحت اطلاعات
            وارد شده بر روی دکمه ثبت اطلاعات کلیک کنید.</p>
        <br />
        <p>
            <span class="style1">*</span> کاربر گرامی در صورتی که&nbsp; اطلاعات ملک شما از سوی
            مدیر سایت تایید شود در بخش لیست املاک و جستجوی ملک قابل مشاهده می باشد.</p>
        <p>
            <span class="style1">*</span> کاربر گرامی در وارد کردن داده ها به موارد زیر توجه
            فرمایید:</p>
        <p>
            <span class="style1">-</span> مقدار قیمت را به میلیون با عدد وارد کنید.</p>
        <p>
            <span class="style1">-</span> فاصله از شهر را به کیلومتر با عدد وارد کنید.</p>
        <p>
            <span class="style1">-</span> متراژ را به متر مربع و با عدد وارد کنید.</p>
        <p>
            <span class="style1">-</span> سن بنا را به سال و با عدد وارد کنید.</p>
        <p>
            <span class="style1">- </span>در صورتی که&nbsp; فیلدی را برای وارد کردن داده مورد
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td align="right" colspan="5" dir="rtl">
                                                ...
                                                شما می توانید ملک مورد نظر خود را با توجه به گزینه های مورد نظر ویرایش کنید ، در
                                                تعیین گزینه ها دقت فرمایید.<br />
                                                <br />
                                                <hr style="color: #99CCFF; font-size: medium;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="right" dir="rtl" style="border: thin solid #CCCCCC" colspan="2">
                                                <asp:DropDownList ID="DropDownList_ostan_bagh" runat="server" DataSourceID="SqlDataSource1"
                                                    DataTextField="name" DataValueField="ID" OnSelectedIndexChanged="DropDownList_ostan_bagh_SelectedIndexChanged"
                                                    AutoPostBack="True" Width="100px" OnDataBound="DropDownList_ostan_bagh_DataBound">
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Amlak %>"
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" colspan="4" dir="rtl" style="border: thin solid #CCCCCC">
                                                <asp:TextBox ID="TextBox_description_bagh" runat="server" Height="100px" Rows="3"
                                        ...
                                        <tr>
                                            <td align="center" dir="rtl" style="font-size: small; color: #000000" colspan="5">
                                                <asp:Button ID="Button_Edit_bagh" runat="server" Font-Names="Tahoma" Text="ویرایش اطلاعات"
                                                    OnClick="Button_Edit_bagh_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div style="border-style: solid">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" dir="rtl" style="border: thin solid #CCCCCC">
                                                <asp:DropDownList ID="DropDownList_ostan_zamin" runat="server" AutoPostBack="True"
                                                    DataSourceID="SqlDataSource1" DataTextField="name" DataValueField="ID" OnSelectedIndexChanged="DropDownList_ostan_zamin_SelectedIndexChanged"
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" colspan="3" dir="rtl" style="border: thin solid #CCCCCC">
                                                <asp:TextBox ID="TextBox_description_zamin" runat="server" Height="100px" Rows="3"
                                                    Width="350px"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center" colspan="4" dir="rtl" style="font-size: small; color: #000000">
                                                <asp:Button ID="Button_Edit_zamin" runat="server" Font-Names="Tahoma" Text="ویرایش اطلاعات"
                                                    OnClick="Button_Edit_zamin_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" colspan="4" dir="rtl" style="font-size: small; color: #000000">
                            ...
                            <div style="border-style: solid">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" dir="rtl" style="border: thin solid #CCCCCC">
                                            <asp:DropDownList ID="DropDownList_ostan_villa" runat="server" AutoPostBack="True"
                                                DataSourceID="SqlDataSource1" DataTextField="name" DataValueField="ID" OnSelectedIndexChanged="DropDownList_ostan_villa_SelectedIndexChanged"
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" colspan="3" dir="rtl" style="border: thin solid #CCCCCC">
                                            <asp:TextBox ID="TextBox_description_vila" runat="server" Height="100px" Rows="3"
                                                Width="350px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" dir="rtl" style="font-size: small; color: #000000" colspan="4">
                                            <asp:Button ID="Button_Edit_vila" runat="server" Font-Names="Tahoma" Text="ویرایش اطلاعات"
                                                OnClick="Button_Edit_vila_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="4" dir="rtl" style="font-size: small; color: #000000">
                            ...
                            <div style="border-style: solid">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" dir="rtl" style="border: thin solid #CCCCCC" colspan="2">
                                            &nbsp;<asp:DropDownList ID="DropDownList_Ostan" runat="server" AutoPostBack="True"
                                                DataSourceID="SqlDataSource1" DataTextField="name" DataValueField="ID" OnSelectedIndexChanged="DropDownList_Ostan_SelectedIndexChanged"
                                                Width="100px" OnDataBound="DropDownList_Ostan_DataBound">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" colspan="4" dir="rtl" style="border: thin solid #CCCCCC">
                                            <asp:TextBox ID="TextBox_description_khaneh" runat="server" Height="100px" Rows="3"
                                                Width="350px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" dir="rtl" style="font-size: small; color: #000000" colspan="5">
                                            <asp:Button ID="Button_Edit_khaneh" runat="server" Font-Names="Tahoma" Text="ویرایش اطلاعات"
                                                OnClick="Button_Edit_khaneh_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="5" dir="rtl" style="font-size: small; color: #000000">
                        ...
                        <asp:View ID="View_show_melk" runat="server">
                            <div style="border-style: solid">
                                <table style="width: 100%;">
                                    <tr>
                                        <td>
                                            <div align="center" dir="rtl" style="font-weight: 700; font-size: 15pt; color: #FFFFFF">
                                    ...
                                    <tr>
                                        <td>
                                            <div align="center" dir="rtl" style="font-weight: 700; font-size: small; color: #FFFFFF">
                                                لیست باغ های ثبت شده</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GridView_Edit_bagh" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource_bagh" ForeColor="#333333"
                                                GridLines="None" OnSelectedIndexChanged="GridView_Edit_bagh_SelectedIndexChanged"
                                                Width="100%" onrowdatabound="GridView_Edit_bagh_RowDataBound">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="metrazh" HeaderText="متراژ" SortExpression="metrazh" />
                                                    <asp:BoundField DataField="type" HeaderText="نوع کشت" SortExpression="type" />
                                                    <asp:BoundField DataField="aj_fo" HeaderText="به منظور" SortExpression="aj_fo" />
                                                    <asp:BoundField DataField="ghaimat" HeaderText="قیمت" SortExpression="ghaimat" />
                                                    <asp:TemplateField HeaderText="تاریخ">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label_bagh" runat="server" Text='<%# Eval("date_insert") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:CommandField EditText="" ShowSelectButton="True" SelectText="ویرایش">
                                                ...
                                                <EmptyDataTemplate>
                                                    کاربر گرامی هیچ باغی از سوی شما به ثبت نرسیده است.
                                                </EmptyDataTemplate>
                                                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                                                <HeaderStyle BackColor="#5D7B9D" Font-Bold="False" ForeColor="White" Font-Size="X-Small" />
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource_bagh" runat="server" ConnectionString="<%$ ConnectionStrings:Amlak %>"
                                                SelectCommand="SELECT       melk_baghe.ID,ostan.name, shahr.name AS Expr1, melk_baghe.rosta, melk_baghe.metrazh, melk_baghe.type, melk_baghe.aj_fo, melk_baghe.ghaimat, 
...
WHERE ID_Member=@id
ORDER BY  melk_baghe.date_insert DESC">
                                                <SelectParameters>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GridView_Edit_vila" runat="server" AutoGenerateColumns="False"
                                                CellPadding="4" DataSourceID="SqlDataSource_Edit_vila" ForeColor="#333333" GridLines="None"
                                                DataKeyNames="ID" AllowPaging="True" OnSelectedIndexChanged="GridView_Edit_vila_SelectedIndexChanged"
                                                Width="100%" onrowdatabound="GridView_Edit_vila_RowDataBound">
                                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                <Columns>
                                                ...
                                                <EditRowStyle BackColor="#999999" />
                                                <EmptyDataTemplate>
                                                    کاربر گرامی هیچ ویلایی از سوی شما به ثبت نرسیده است.
                                                </EmptyDataTemplate>
                                                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                                                <HeaderStyle BackColor="#5D7B9D" Font-Bold="False" ForeColor="White" Font-Size="X-Small" />
                                                <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource_Edit_vila" runat="server" ConnectionString="<%$ ConnectionStrings:Amlak %>"
                                                SelectCommand="SELECT      melk_vila.ID,  ostan.name, shahr.name AS Expr1, melk_vila.metrazh, melk_vila.age, melk_vila.state, melk_vila.aj_fo, melk_vila.ghaimat, melk_vila.date_insert
...
WHERE melk_vila.ID_Member=@id
ORDER BY melk_vila.date_insert DESC">
                                                <SelectParameters>
                                                    <asp:SessionParameter Name="id" SessionField="id_user" />
                                                </SelectParameters>
                                            </asp:SqlDataSource>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GridView_Edit_zamin" runat="server" AutoGenerateColumns="False"
                                                CellPadding="4" DataSourceID="SqlDataSource_Edit_zamin" 
                                                ForeColor="#333333" GridLines="None"
                                                AllowPaging="True" DataKeyNames="ID" OnSelectedIndexChanged="GridView_Edit_zamin_SelectedIndexChanged"
                                                Width="100%" onrowdatabound="GridView_Edit_zamin_RowDataBound">
                                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                <Columns>
                                                    <asp:BoundField DataField="ID" HeaderText="ID" SortExpression="ID" InsertVisible="False"
                                                        ReadOnly="True" Visible="False" />
                                                ...
                                                <EditRowStyle BackColor="#999999" />
                                                <EmptyDataTemplate>
                                                    کاربر گرامی هیچ زمینی از سوی شما به ثبت نرسیده است.
                                                </EmptyDataTemplate>
                                                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                                                <HeaderStyle BackColor="#5D7B9D" Font-Bold="False" ForeColor="White" Font-Size="X-Small" />
                                                <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource_Edit_zamin" runat="server" ConnectionString="<%$ ConnectionStrings:Amlak %>"
                                                SelectCommand="SELECT       melk_zamin.ID, ostan.name, shahr.name AS Expr1, melk_zamin.metrazh, melk_zamin.ghaimat, melk_zamin.state, melk_zamin.type, melk_zamin.date_insert
...
WHERE melk_zamin.ID_Member=@id
ORDER BY melk_zamin.date_insert DESC">
                                                <SelectParameters>
                                                    <asp:SessionParameter Name="id" SessionField="id_user" />
                                                </SelectParameters>
                                            </asp:SqlDataSource>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GridView_Edit_khaneh" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                CellPadding="4" DataKeyNames="ID" DataSourceID="SqlDataSource_Edit_khaneh" ForeColor="#333333"
                                                GridLines="None" OnSelectedIndexChanged="GridView_Edit_khaneh_SelectedIndexChanged"
                                                Width="100%" onrowdatabound="GridView_Edit_khaneh_RowDataBound">
                                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                <Columns>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource_Edit_khaneh" runat="server" ConnectionString="<%$ ConnectionStrings:Amlak %>"
                                                SelectCommand="SELECT        melk_house.ID,ostan.name, shahr.name AS Expr1, melk_house.metrazh, melk_house.age, melk_house.state, melk_house.ghaimat, melk_house.aj_fo, melk_house.type, 
...
WHERE  melk_house.ID_Member=@ID
ORDER BY  melk_house.date_insert  DESC">
                                                <SelectParameters>
                                                    <asp:SessionParameter Name="ID" SessionField="id_user" />
                                                </SelectParameters>
                                            </asp:SqlDataSource>
