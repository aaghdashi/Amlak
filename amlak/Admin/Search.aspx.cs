...
namespace amlak.Admin
{
    public partial class Search : System.Web.UI.Page
    {
        ...
        protected void Button_Search_bagh_Click(object sender, EventArgs e)
        {
            ...
            _command = "SELECT melk_baghe.ID,ostan.name, shahr.name AS Expr1, melk_baghe.rosta, melk_baghe.metrazh, melk_baghe.type, melk_baghe.aj_fo, melk_baghe.ghaimat,melk_baghe.date_insert FROM melk_baghe INNER JOIN ostan ON melk_baghe.ID_ostan = ostan.ID INNER JOIN shahr ON melk_baghe.ID_shahr = shahr.ID AND ostan.ID = shahr.ID_ostan  WHERE 1=1 ";
        ...
        protected void Button_Search_vila_Click(object sender, EventArgs e)
        {
            ...
            _command = "SELECT melk_vila.ID, ostan.name, shahr.name AS Expr1, melk_vila.metrazh, melk_vila.age, melk_vila.state, melk_vila.em_ab, melk_vila.em_bargh, melk_vila.em_gaz, melk_vila.em_tele, melk_vila.em_moble, melk_vila.em_estakhr, melk_vila.em_kafposh, melk_vila.em_service_ashpaz, melk_vila.em_entrance, melk_vila.em_yard, melk_vila.em_anbari, melk_vila.em_parking, melk_vila.aj_fo, melk_vila.address, melk_vila.ghaimat, melk_vila.fasele_shahr, melk_vila.description, melk_vila.date_insert FROM melk_vila INNER JOIN ostan ON melk_vila.ID_ostan = ostan.ID INNER JOIN  shahr ON melk_vila.ID_shahr = shahr.ID AND ostan.ID = shahr.ID_ostan  WHERE 1=1 ";
