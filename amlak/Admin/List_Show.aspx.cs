...
namespace amlak.Admin
{
    public partial class List_Show : System.Web.UI.Page
    {
        ...
        protected void GridView_bagh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string _Command;
            _Command = "SELECT ID_ostan, ID_shahr, rosta, address, metrazh, type, mahsol, fasele_shar, aj_fo, ghaimat, description, em_ab, em_bargh, em_gaz, em_telephone, em_jhah, em_khane_vilai, em_estakhr,permission FROM melk_baghe WHERE ID='" + _id_bagh + "' ";
            ...
            CheckBox_bagh_permission.Checked = (bool)_dr[18];
            _dr.Close();
        ...
        protected void GridView_vila_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string _Command;
            _Command = "SELECT  ID_ostan, ID_shahr, metrazh, age, state, em_ab, em_bargh, em_gaz, em_tele, em_moble, em_estakhr, em_kafposh, em_service_ashpaz, em_entrance, em_parking, em_yard, em_anbari, aj_fo, address, ghaimat, fasele_shahr, description,permission FROM   melk_vila WHERE ID='" + _id_vila + "' ";
            New_connection.ConnectionString = New_user._Conection_String;
            New_connection.Open();
            New_command.Connection = New_connection;
            New_command.CommandText = _Command;
            ...
            CheckBox_vila_permission.Checked = (bool)_dr[22];
            _dr.Close();
            New_connection.Close();
        }
        ...
        protected void GridView_zamin_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string _Command;
            _Command = "SELECT ID_ostan, ID_shahr, metrazh, fasele_shahr, ghaimat, state, type, address, description,permission FROM  melk_zamin WHERE ID='" + _id_zamin + "' ";
            New_connection.ConnectionString = New_user._Conection_String;
            New_connection.Open();
            New_command.Connection = New_connection;
            New_command.CommandText = _Command;
            ...
            CheckBox_zamin_permission.Checked = (bool)_dr[9];
            _dr.Close();
            New_connection.Close();
        }
        ...
        protected void GridView_khaneh_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string _Command;
            _Command = "SELECT   ID_ostan, ID_shahr, metrazh, age, state, ghaimat, address, va_tele, va_gaz, va_bargh, va_ab, em_asansor, em_anbari, em_yard, em_Enterance, em_parking, em_deadend, aj_fo, type, description,permission FROM  melk_house WHERE ID='" + _id_khane + "' ";
            New_connection.ConnectionString = New_user._Conection_String;
            New_connection.Open();
            New_command.Connection = New_connection;
            New_command.CommandText = _Command;
            ...
            CheckBox_khaneh_permission.Checked = (bool)_dr[20];
            _dr.Close();
            New_connection.Close();   
        }
        ...
        {
            Label lbl1 = (Label)e.Row.FindControl("Label_date_bagh");
            if (lbl1 != null)
            {
